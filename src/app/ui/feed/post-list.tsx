    ...
    return (   
        ...
        {posts?.map((post) => (
            <div key={post.post_id} className=" relative m-4 bg-main-2 p-4 rounded-md shadow-md">
                ...
                <button id="like-button" type="button" className= "text-main-1 border border-main-1 md:hover:bg-secondary-1 hover:text-main-2 font-medium rounded-md text-sm p-2.5 text-center inline-flex items-center me-2 shadow-md absolute right-4 bottom-4">
