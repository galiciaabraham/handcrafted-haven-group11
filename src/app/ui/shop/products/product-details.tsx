...
export default async function ProductDetails({id}: {id:string}){
    ...
    const {product_title, product_price, product_description, product_image_url} = productDetails;
    return(
        <div className="bg-main-2 p-4 md:p-6 rounded-lg text-black text-center">
            ...
            <div className="grid grid-cols-3 gap-5 my-8 mx-2 items-center">
                ...
                <button className="bg-main-1 text-main-2 p-2 rounded-md shadow-md h-10 md:hover:bg-main-2 md:hover:text-secondary-2 col-span-1 col-start-3">Buy</button>
            </div>
        </div>
    );
}